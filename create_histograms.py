...
def create_histograms(config,data_type,Dir_import):
    # Outputs     
    # Histogram_training_depth_LR_DS    : LR Histograms for Training Inputs
    # Histogram_validation_depth_LR_DS  : LR Histograms for Validation Inputs
    ...
    # ---- 1.bis Check NaN Inf values  + Crop  modulo scale -------------------------------------------------------------
