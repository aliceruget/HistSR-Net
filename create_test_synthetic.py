...
Import_Dir = '/home/ar432/DepthSR_Net/Dataset/Raw_data/Raw_data_Middlebury_MPI'
depth = sio.loadmat(os.path.join(Import_Dir, 'depth_total.mat'))
depth = depth['depth_data_2005']
intensity = sio.loadmat(os.path.join(Import_Dir, 'intensity_total.mat'))
intensity = intensity['intensity_data_2005']
...
I_up = I_up[300:700, 0:400]
intensity_image = intensity_image[300:700, 0:400]
...
#for SBR_mean = []
size = np.linspace(0.004,0.000004, num = 100)
for SBR_mean in size:
    ...
    Dir = '/home/ar432/Dataset/Test/dif_SBR_bis'
    #save_path = '/Users/aliceruget/Documents/PhD/HistSR_Net_AR/Dataset/TEST/Synthetic_data/depth_4/DATA_TEST_art_i10_b1/'
    #save_path = os.path.join(Dir, 'depth_'+str(scale), 'DATA_TEST_art_rescaled_intensity_level='+str(intensity_level)+'_ambient_type='+str(ambient_type)+'_SBR_mean='+str(SBR_mean))
    save_path = os.path.join(Dir, 'SBR_'+ str(SBR_mean))
    #'_rescaled'+
    print(save_path)
