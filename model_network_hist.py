...
class SRCNN(object):
  ...
  def model(self):
    ...
    with tf.compat.v1.variable_scope("main_branch") as scope3:
      conv1_b, w1, bias1, conv1_b_b = conv2d_1st_conv(self.images, 1,64, k_h=3, k_w=3, d_h=1, d_w=1,name="conv2d_1")
      #conv1_b, w1, bias1 = conv2d(self.images, 1,64, k_h=3, k_w=3, d_h=1, d_w=1,name="conv2d_1")
      ...
      pool1_input = self.pool1_input #pool1_input=max_pool_2x2(self.images)
      ...
      pool2_input = self.pool2_input #pool2_input=max_pool_2x2(pool1_input)
      ...
      pool3_input = self.pool3_input #pool3_input=max_pool_2x2(pool1_input)
      ...
      pool4_input = self.pool4_input #pool4_input=max_pool_2x2(pool3_input)
      ...
      dictionary_bis = {'encoder_conv':{'conv1':conv1, 'conv2':conv2, 'conv3':conv3,'conv4':conv4, 'conv5':conv5, 'conv6':conv6,'conv7' : conv7, 'conv8':conv8, 'conv9':conv9, 'conv10':conv10},\
            'encoder_conv_before_relu':{'conv1_b':conv1_b, 'conv2_b':conv2_b, 'conv3_b':conv3_b,'conv4_b':conv4_b, 'conv5_b':conv5_b, 'conv6_b':conv6_b,'conv7_b' : conv7_b, 'conv8_b':conv8_b, 'conv9_b':conv9_b, 'conv10_b':conv10_b},\
            'encoder_conv_before_bias':{'conv1_b_b':conv1_b_b}, \
           ...
           'decoder_conv':{'deconv2':deconv2,'deconv3':deconv3, 'deconv4':deconv4, 'deconv5':deconv5, 'conv13':conv13,\
            ...
            'decoder_conv_before_relu':{'deconv2_b':deconv2_b,'deconv3_b':deconv3_b, 'deconv4_b':deconv4_b, 'deconv5_b':deconv5_b, 'conv13_b':conv13_b,\
              'conv14_b' : conv14_b, 'conv15_b':conv15_b, 'conv16_b':conv16_b, 'conv17_b':conv17_b,'conv18_b' : conv18_b, 'conv19_b':conv19_b, 'conv20_b':conv20_b}, \
           ...
           'I_branch_F_conv_before_relu':{'conv1_f_b':conv1_f_b, 'conv3_f_b':conv3_f_b,'conv5_f_b':conv5_f_b,'conv7_f_b' : conv7_f_b}, \
           ...
           'Input_Pyramid_conv_before_relu':{'conv_input1_b':conv_input1_b, 'conv_input2_b':conv_input2_b, 'conv_input3_b':conv_input3_b, 'conv_input4_b':conv_input4_b},\
  ...
  def model_test(self):
    ...
    with tf.compat.v1.variable_scope("main_branch", reuse = True):
      ...
      pool1_input=self.pool1_input_test #max_pool_2x2(self.depth_test)
      ...
      pool2_input = self.pool2_input_test#max_pool_2x2(pool1_input)
      ...
      pool3_input = self.pool3_input_test#max_pool_2x2(pool2_input)
      ...
      pool4_input=self.pool4_input_test#max_pool_2x2(pool3_input)
      ...
      dictionary_bis = {'encoder_conv':{'conv1':conv1, 'conv2':conv2, 'conv3':conv3,'conv4':conv4, 'conv5':conv5, 'conv6':conv6,'conv7' : conv7, 'conv8':conv8, 'conv9':conv9, 'conv10':conv10},\
           ...
           'I_branch_F_bias':{'bias1_f': bias1_f, 'bias3_f': bias3_f, 'bias5_f': bias5_f, 'bias7_f': bias7_f}, \
           'Input_Pyramid_bias':{'bias_input1':bias_input1, 'bias_input2':bias_input2, 'bias_input3':bias_input3, 'bias_input4':bias_input4},\
           'data':{ 'depth_down':self.depth_test, 'I_add':self.I_add_test}}

      dictionary = {'data':{'depth_down':self.depth_test, 'I_add':self.I_add_test},\
        'results':{'result' : output, 'residual_map':residual_map}}
